module.exports = {
  TOKEN: process.env.TOKEN || "MTIyMjYyMDA3MzE5ODYxNjU4Ng.GYNSZy.flQeel4mrRXYH8h_6hMWIzRBh2IizlKsh3X4bE",
  ...
  links: {
    ...
    DiscordServer: process.env.DiscordServer || `https://discord.gg/yZcZzJW2Mh`,
    VoteURL: process.env.VoteURL || `https://discord.gg/yZcZzJW2Mh`,
  ...
  slash: {
    global: true,
    guildID: process.env.GUILD_ID || "1204148583566409748", // for slash command
  },
};
